...
<head>
    ...
    <title>素材之家</title>
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="/images/admin/inmages/favicon.png">
    <link href="/vendor/jqvmap/css/jqvmap.min.css" rel="stylesheet">
{{--    <link href="{{ URL::asset('vendor/bootstrap/jqvmap/css/jqvmap/min/css') }}" rel="stylesheet">--}}
    ...
    ***********************************-->
    <div class="nav-header">
        <a href="index.html" class="brand-logo">
            <img class="logo-abbr" src="/images/admin/inmages/logo.png" alt="">
            <img class="logo-compact" src="/images/admin/inmages/logo-text.png" alt="">
            <img class="brand-title" src="/images/admin/inmages/logo-text.png" alt="">
        </a>
                            ...
                            <ul class="contacts">
                                ...
                                <li class="active dz-chat-user">
                                    <div class="d-flex bd-highlight">
                                        <div class="img_cont">
                                            <img src="/images/admin/images/avatar/1.jpg" class="rounded-circle user_img" alt=""/>
                                ...
                                <li class="dz-chat-user">
                                    <div class="d-flex bd-highlight">
                                        <div class="img_cont">
                                            <img src="/images/admin/images/avatar/2.jpg" class="rounded-circle user_img" alt=""/>
                                ...
                                <li class="dz-chat-user">
                                    <div class="d-flex bd-highlight">
                                        <div class="img_cont">
                                            <img src="/images/admin/images/avatar/3.jpg" class="rounded-circle user_img" alt=""/>
                                            <span class="online_icon"></span>
                                        </div>
                                        <div class="user_info">
                                ...
                                <li class="dz-chat-user">
                                    <div class="d-flex bd-highlight">
                                        <div class="img_cont">
                                            <img src="/images/admin/images/avatar/4.jpg" class="rounded-circle user_img" alt=""/>
                                            <span class="online_icon offline"></span>
                                        </div>
                                        <div class="user_info">
                                ...
                                <li class="dz-chat-user">
                                    <div class="d-flex bd-highlight">
                                        <div class="img_cont">
                                            <img src="/images/admin/images/avatar/5.jpg" class="rounded-circle user_img" alt=""/>
                                            <span class="online_icon offline"></span>
                                        </div>
                                        <div class="user_info">
                        ...
                        <div class="card-body msg_card_body dz-scroll" id="DZ_W_Contacts_Body3">
                            <div class="d-flex justify-content-start mb-4">
                                <div class="img_cont_msg">
                                    <img src="/images/admin/images/avatar/1.jpg" class="rounded-circle user_img_msg" alt=""/>
                                </div>
                            ...
                            <div class="d-flex justify-content-end mb-4">
                                ...
                                <div class="img_cont_msg">
                                    <img src="/images/admin/images/avatar/2.jpg" class="rounded-circle user_img_msg" alt=""/>
                                </div>
                            </div>
                            <div class="d-flex justify-content-start mb-4">
                                <div class="img_cont_msg">
                                        ...
                                        <li>
                                            <div class="timeline-panel">
                                                <div class="media mr-2">
                                                    <img alt="image" width="50" src="/images/admin/images/avatar/1.jpg">
                                                </div>
                                ...
                                <div class="card-body pb-0">
                                    <div class="pb-3 border-bottom mb-3">
                                        <div class="d-flex mb-3 flex-wrap align-items-end">
                                            <img class="rounded mr-3" src="images/customers/1.jpg" width="58" alt="">
                                            <div>
                                    ...
                                    <div class="pb-3 border-bottom mb-3">
                                        <div class="d-flex mb-3 flex-wrap align-items-end">
                                            <img class="rounded mr-3" src="images/customers/2.jpg" width="58" alt="">
                                            <div>
                                    ...
                                    <div class="pb-3">
                                        <div class="d-flex mb-3 flex-wrap align-items-end">
                                            <img class="rounded mr-3" src="images/customers/3.jpg" width="58" alt="">
                                            <div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="testimonial-one owl-carousel">
                                        <div class="items">
                                            <a href="property-details.html"><img src="images/testimonial/1.png" alt="#" class="w-100 mw-100 mb-3 rounded"></a>
